...
public class AutoCommit {
    ...
    /**
     * When auto-commit is enabled, Kafka periodically commits the offsets of messages that have been consumed,
     * without requiring explicit acknowledgment from the consumer.
     * Pre-Requisite:
